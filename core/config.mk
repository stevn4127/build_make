...
ifneq ($(GANJA_BUILD),)
include vendor/ganja/config/BoardConfigGanja.mk
endif
...
ifneq ($(GANJA_BUILD),)
ifneq ($(wildcard device/ganja/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/ganja/sepolicy/common/sepolicy.mk)
endif
endif
